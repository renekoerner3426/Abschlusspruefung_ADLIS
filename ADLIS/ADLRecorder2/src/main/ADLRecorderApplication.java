...
public class ADLRecorderApplication {
	...
	private static void sendPost() throws Exception {
		...
		URL url = new URL("http://localhost:8082/newDecree");
	...
	private static void createJsonAsString(ADLRecord adbRecord, StringBuilder jsonBuilder) {
		jsonBuilder.append("{");
	...
	private static void appendCreatedJsonPart(String attribute, String value, StringBuilder jsonBuilder) {
		jsonBuilder.append(createJsonPart(attribute, value));
	}

	private static String createJsonPart(String attribute, String value) {
	...
	private static HttpURLConnection establishConnection(URL url) throws IOException, ProtocolException {
